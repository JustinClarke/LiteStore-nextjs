                    ...
                    <div className="flex flex-wrap gap-6">
                        <div data-aos="fade-up" data-aos-delay="100" className="py-4 px-4 lg:w-1/3 border-2 border-gray-200 border-opacity-60 rounded-lg">
                            ...
                            <div className="h-full flex items-start">
                                <div className="w-12 flex-shrink-0 flex flex-col text-center leading-none">
                                    <span className="text-gray-500 dark:text-light-white pb-2 mb-2 border-b-2 border-gray-200">May</span>
                                    <span className="dark:text-gray-400 font-medium text-lg text-gray-800 title-font leading-none">19</span>
                                </div>
                                <div className="flex-grow pl-6">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-indigo-500 mb-1">The Future of Retail:</h2>
                                    <h1 className="title-font text-xl font-medium text-gray-900 dark:text-gray-300 mb-3">More Than Just Space - I</h1>
                                    ...
                                    <div className="flex">
                                        <Link href="/blog/the-future-of-retail-1">
                                            <a className="inline-flex text-base  border-purple border-2 py-2 px-4 focus:outline-none hover:text-white hover:bg-darker-purple active:bg-black rounded transition ease-in-out delay-10 duration-200 hover:-translate-y-1 hover:scale-110" target="_blank" rel="noreferrer">
                        ...
                        <div data-aos="fade-up" data-aos-delay="200" className="py-4 px-4 lg:w-1/3 border-2 border-gray-200 border-opacity-60 rounded-lg">
                            ...
                            <div className="h-full flex items-start">
                                ...
                                <div className="flex-grow pl-6">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-indigo-500 mb-1">The Future of Retail:</h2>
                                    <h1 className="title-font text-xl font-medium text-gray-900 dark:text-gray-300 mb-3">More Than Just Space - II</h1>
