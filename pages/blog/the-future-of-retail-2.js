...
export default function blog() {
	return (
		<div>
			...
			<Header />
			<div data-aos="fade-up" data-aos-delay="100" className="px-5 md:px-80 pt-5 md:pt-5 pb-10 font-light text-justify">
				<h1 className="py-5 font-serif text-gray-700 dark:text-gray-400 text-4xl text-center">The Future of Retail: More Than Just Space - II</h1>
				<p><span className="font-semibold">Date:</span> 19 May 2021</p>
				<p className="pt-3">
					In the previous
					<Link href="/blog/the-future-of-retail-1"><a className="font-semibold text-purple dark:text-darker-purple hover:text-black dark:hover:text-light-white"> blog post</a>
				...
				<p className="py-3">
					...
					<a className="font-semibold text-purple dark:text-darker-purple hover:text-black dark:hover:text-light-white" href="https://www.blueskydreamers.com/why-do-fancy-restaurants-serve-small-portions/" target="_blank" rel="noreferrer"> small portions </a>
				...
				<div className="py-3 w-full md:w-1/2 mx-auto">
					...
					<div className="pt-2 font-semibold text-purple dark:text-darker-purple hover:text-black dark:hover:text-light-white">
						<a href="http://www.pen-online.jp">Picture Credits: Pen Online</a>
					</div>
				</div>
				<p className="py-3 font-semibold">
					II. Less is more - keeping the experience intimate
				...
				<p className="py-3">
					...
					<a
						className="font-semibold text-purple dark:text-darker-purple hover:text-black dark:hover:text-light-white"
				...
				<div className="py-3 w-full md:w-1/2 mx-auto">
					...
					<div className="pt-2 font-semibold text-purple dark:text-darker-purple hover:text-black dark:hover:text-light-white">
						<a href="https://www.artsy.net">Picture Credits: Artsy</a>
					</div>
				</div>
				<p className="py-3">
