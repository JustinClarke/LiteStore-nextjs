...
export default function Contact() {
	...
	return (
		<div>
			...
			<section data-aos="fade" data-aos-delay="50" className="body-font relative">
				<div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
					<div className="md:w-2/3 bg-gray-300 dark:bg-black rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
						...
						<div data-aos="fade-up" data-aos-delay="100" className="grid grid-cols-2 bg-white dark:bg-black relative py-6 rounded shadow-md transition ease-in-out delay-100 duration-300 hover:-translate-y-1 hover:scale-105">
					...
					<form className="md:w-1/3 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
						<h1 data-aos="fade-up" data-aos-delay="100" className="font-bold text-3xl">GET IN TOUCH</h1>
						<p data-aos="fade-up" data-aos-delay="100" className="leading-relaxed mb-5 text-gray-300">We would love to hear from you!</p>
						<div data-aos="fade-up" data-aos-delay="100" className="relative mb-4">
							...
							<input onChange={e => setName(e.target.value)} type="text" id="name" name="name" className="w-full appearance-none block text-gray-700 dark:bg-black dark:border-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500 hover:border-gray-500 transition ease-in-out delay-10 duration-200" />
						</div>
						<div data-aos="fade-up" data-aos-delay="100" className="relative mb-4">
							<label htmlFor="email" className="leading-7 text-sm text-gray-300">Email</label>
							<input onChange={e => setEmail(e.target.value)} type="email" id="email" name="email" className="w-full appearance-none block text-gray-700 dark:bg-black dark:border-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500 hover:border-gray-500 transition ease-in-out delay-10 duration-200" />
						</div>
						<div data-aos="fade-up" data-aos-delay="100" className="relative mb-4">
