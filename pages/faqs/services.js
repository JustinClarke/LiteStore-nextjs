...
export default function index() {
    return (
        <div>
            ...
            <Header />
            <h1 data-aos="fade-up" className="px-5 md:px-40 py-5 text-6xl font-semibold"><span className="text-purple">LiteStore</span> Services</h1>
            <div data-aos="fade-up" className="px-5 md:px-40 pb-10 text-justify">
                {data[3].services.map(({ question, answer }) => (
                    <Accordion key={services.id}>
                        <AccordionSummary
