                                ...
                                <a className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                    <div data-aos="fade-up">
                                        <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="text-purple dark:text-darker-purple w-12 h-12 mb-8 inline-block" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <h2 className="title-font font-medium text-3xl">General</h2>
                                        </div>
                                    </div>
                                </a>
                            </Link>
                                ...
                                <a className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                    <div data-aos="fade-up">
                                        <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                            ...
                                            <h2 className="title-font font-medium text-3xl">Landowners</h2>
                                        </div>
                                    </div>
                                </a>
                            </Link>
                                ...
                                <a className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                    <div data-aos="fade-up">
                                        <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                            ...
                                            <h2 className="title-font font-medium text-3xl">Brands</h2>
                                        </div>
                                    </div>
                                </a>
                            </Link>
                                ...
                                <a className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                    <div data-aos="fade-up">
                                        <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                            ...
                                            <h2 className="title-font font-medium text-3xl">Services</h2>
                                        </div>
                                    </div>
                                </a>
                            </Link>
