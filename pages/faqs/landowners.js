        ...
        <div>
            ...
            <div className="px-5 md:px-40">
                <div className="grid grid-cols-1 md:grid-cols-3 py-5">
                    <h1 data-aos="fade-up" className="col-span-1 pt-5 text-6xl font-semibold"><span className="text-purple">Landowners</span> FAQs</h1>
                        ...
                        <div class="container py-5">
                            <div class="flex flex-wrap -m-4 text-center justify-end">
                                ...
                                <Link href="/faqs/brands">
                                    <a class="p-2 md:p-4 w-full md:w-auto">
                                        <div class="border-2 border-gray-200 px-2 py-2 md:px-4 md:py-4 rounded-lg transition ease-in-out delay-10 duration-200 hover:-translate-y-1 hover:scale-110">
                                            <p class="leading-relaxed">Brands FAQs</p>
                                        </div>
                                    </a>
                                </Link>
                ...
                <div data-aos="fade-up" className="pb-10">
                    {data[1].general.map(({ question, answer }, key) => (
                ...
                <div data-aos="fade-up" className="pb-10">
                    {data[1].howitworks.map(({ question, answer }, key) => (
                        <Accordion key={key} className="transition ease-in-out delay-10 duration-500 hover:-translate-y-1 hover:scale-102 hover:text-purple">
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon />}
                                aria-controls="panel1a-content"
                ...
                <div data-aos="fade-up" className="pb-10">
                    {data[1].legal.map(({ question, answer }, key) => (
                        <Accordion key={key} className="transition ease-in-out delay-10 duration-500 hover:-translate-y-1 hover:scale-102 hover:text-purple">
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon />}
                                aria-controls="panel1a-content"
                ...
                <div data-aos="fade-up" className="pb-10">
                    {data[1].payments.map(({ question, answer }, key) => (
                        <Accordion key={key} className="transition ease-in-out delay-10 duration-500 hover:-translate-y-1 hover:scale-102 hover:text-purple">
                            <AccordionSummary
                                expandIcon={<ExpandMoreIcon />}
                                aria-controls="panel1a-content"
