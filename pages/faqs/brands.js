    ...
    return (
        <div>
            ...
            <div className="px-5 md:px-40 py-5">
                <h1 data-aos="fade-up" className="py-5 text-6xl font-semibold"><span className="text-purple">Brands</span> FAQs</h1>
                ...
                <div data-aos="fade-up" className="pb-10 text-justify">
                    {data[2].howitworks.map(({ question, answer }) => (
                ...
                <div data-aos="fade-up" className="pb-10 text-justify">
                    {data[2].booking.map(({ question, answer }) => (
                ...
                <div data-aos="fade-up" className="pb-10 text-justify">
                    {data[2].legal.map(({ question, answer }) => (
                ...
                <div data-aos="fade-up" className="pb-10 text-justify">
                    {data[2].payments.map(({ question, answer }) => (
