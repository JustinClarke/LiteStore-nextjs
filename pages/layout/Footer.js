        ...
        <footer className="text-center lg:text-left text-sm">
                ...
                <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-5 gap-1">
                    <div>
                        <h6 className="text-4xl font-extralight mb-4 flex justify-center md:justify-start">
                            LiteStore<sup className="text-sm">®</sup>
                        </h6>
                        ...
                        <div className="font-light">
                            <p className="flex items-center justify-center md:justify-start mb-4">
                                ...
                                <br />Indira Nagar 1st Stage,
                                <br />Stage 1, Indiranagar,
                                <br />Bengaluru, Karnataka 560038
                            </p>
                            <p className="flex items-center justify-center md:justify-start mb-4">
            ...
            <div className="px-5 md:px-40 flex justify-center items-center lg:justify-between bg-light-white">
                ...
                <div className="flex justify-center">
                    ...
                    <a href="https://www.google.com/search?client=safari&rls=en&q=litestore&ie=UTF-8&oe=UTF-8" className="p-6 fill-purple hover:fill-light-white hover:bg-black transition ease-in-out delay-10 duration-200">
                    ...
                    <a href="https://www.instagram.com/litestore.india" className="p-6 fill-purple hover:fill-light-white hover:bg-black transition ease-in-out delay-10 duration-200">
                    ...
                    <a href="https://www.linkedin.com/company/litestore" className="p-6 fill-purple hover:fill-light-white hover:bg-black transition ease-in-out delay-10 duration-200">
