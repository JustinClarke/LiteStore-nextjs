                ...
                <section className="text-gray-600 body-font">
                    <div className="px-5 md:px-40 py-10 lg:py-36 mx-auto">
                        <div className="flex flex-wrap -m-4 text-center">
                            ...
                            <a href="https://litestore-faqs.vercel.app/faqs/faqs-general.html" className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                            ...
                            <a href="https://litestore-faqs.vercel.app/faqs/faqs-for-landowners.html" className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                <div data-aos="fade-up">
                                    <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="text-purple w-12 h-12 mb-8 inline-block" viewBox="0 0 24 24">
                            ...
                            <a href="https://litestore-faqs.vercel.app/faqs/faqs-for-brands.html" className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                <div data-aos="fade-up">
                                    <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="text-purple w-12 h-12 mb-8 inline-block" viewBox="0 0 24 24">
                            ...
                            <a href="https://litestore-faqs.vercel.app/faqs/faqs-litestore.html" className="p-4 md:w-1/4 sm:w-1/2 w-full hover:scale-110 transition ease-in-out duration-500">
                                <div data-aos="fade-up">
                                    <div className="border-2 border-gray-200 px-4 py-10 rounded-lg">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="text-purple w-12 h-12 mb-8 inline-block" viewBox="0 0 24 24">
